...
const sampleCard3 = new Card({ bank: 'TD', number: '2109876549876543', balance: 10000, holder: 'Jane Smith', expiryDate: '11/23', cvv: '456', color: 'cool-purple', provider: 'master-card' });
